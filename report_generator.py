...
Respond ONLY as a JSON object with this exact shape:
{
  "overall_summary": "...",
  "findings": [
    {"table": "...", "plain_explanation": "...", "business_impact": "...", "sql_fix": "..."}
  ]
}
"""
...
async def generate_report(scan_report, openai_client) -> dict:
    ...
    explicación + SQL). Si OpenAI falla, devuelve un reporte de respaldo
    simple generado sin IA, para nunca dejar al cliente sin nada después
    de haber pagado.
    """
    ...
    try:
        ...
        return _fallback_report(findings_payload)
